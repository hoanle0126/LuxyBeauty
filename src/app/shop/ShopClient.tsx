...
export default function ShopClient() {
    ...
    // Parse URL params once with useMemo
    ...
    const initialSort = useMemo(() => searchParams.get('sort') || 'newest', [searchParams]);
    const initialPage = useMemo(() => Number(searchParams.get('page')) || 1, [searchParams]);
